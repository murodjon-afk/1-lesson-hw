    ...
    <div className="flex md:hidden justify-center w-full max-w-[375px] mx-auto">
      ...
      <section className="w-full min-h-[70vh] flex flex-col items-center py-10">
        ...
        <div className="w-[85%] mx-auto px-4 sm:px-6 flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-30">
          ...
          <div className="bg-white h-auto lg:h-[400px] w-full lg:w-[350px] shadow-md p-6 flex flex-col items-center text-center hover:shadow-xl transition border-t-[12px] border-[#FF814A]">
          ...
          <div className="bg-white h-auto lg:h-[400px] w-full lg:w-[350px] shadow-md p-6 flex flex-col items-center text-center hover:shadow-xl transition border-t-[12px] border-[#31C5A1]">
            <img src={png3} alt="" className="w-20 h-20 mb-4" />
            <div>
              <h2 className="text-xl font-semibold mb-2">Get your cash</h2>
              <p className="text-gray-500">
                If you qualify, your loan will be disbursed to your wallet.
              </p>
            </div>
          </div>
